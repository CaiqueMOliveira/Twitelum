...
class Tweet extends Component {
    ...
    likeHandler = () => {
        ...
        fetch(`http://twitelum-api.herokuapp.com/tweets/${this.props._id}/like?X-AUTH-TOKEN=${localStorage.getItem('token')}`,{
            method:'POST'
        })
        .then((res) => res.json())
    ...
    render() {
        return (
            <article className="tweet">
                ...
                <p className="tweet__conteudo">{this.props.message}</p>
